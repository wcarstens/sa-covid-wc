...
region_options = {'Worldwide': available_countries, 'South Africa': sa, 'Europe': eu}
...
df_sa = data[data['Country/Region'].isin(sa)]
df_sa = df_sa.append(pd.DataFrame({'date': [pd.to_datetime('2020-01-22'), pd.to_datetime('2020-01-23')],
